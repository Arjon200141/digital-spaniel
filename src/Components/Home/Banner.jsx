...
const Banner = () => {
    return (
        <div className='relative flex lg:justify-start justify-center items-center'>
            ...
            <div className='lg:min-h-screen lg:pl-[15.625%] mt-8 lg:relative absolute z-50 top-[32vh] lg:top-0 lg:w-1/2 lg:pt-24 flex justify-center items-center text-center lg:text-start'>
                <div className='bg-white/50 rounded lg:shadow-none shadow-md py-10 lg:block flex flex-col justify-center items-center'>
                    <p className='w-fit mb-10 banner1 font-semibold'>
                        BRAND, DEV, ECOM, MARKETING
                    </p>
                    <h2 className='w-fit lg:text-[44px] text-[32px] lg:leading-[44px] font-medium banner2'>
                        We unleash <br />
                        <span className='text-[#19293aa4] lg:text-[44px] text-[32px]'>business potential</span>
                    </h2>
                    <p className='text-lg mt-10 leading-6 text-[#506473] text-wrap w-[75%] '>
