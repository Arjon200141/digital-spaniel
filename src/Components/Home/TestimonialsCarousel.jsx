...
const TestimonialsCarousel = () => {
  ...
  return (
    <div className="px-4 relative sm:px-8 md:px-16 lg:px-[6.60%] py-12 md:py-20 bg-gray-50">
      <div className="px-4 sm:px-8 lg:px-[11.625%] flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
      ...
      <div className="relative flex items-center justify-center lg:mb-12 w-full ">
